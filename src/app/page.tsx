...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        { imageSrc: "http://img.b2bpic.net/free-photo/abandoned-sanitarium_181624-18703.jpg", imageAlt: "Luxurious Hotel Lobby" },
        { imageSrc: "http://img.b2bpic.net/free-photo/3d-rendering-luxury-modern-bedroom-suite-hotel-with-tv-cabinet_105762-2276.jpg", imageAlt: "Comfortable Suite Interior" }
      ]}
  ...
  <div id="amenities" data-section="amenities">
      ...
      metrics={[
        ...
        { icon: Utensils, label: "Dining", value: "Michelin Star" },
        { icon: Sparkles, label: "Spa", value: "Full Service" },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={true}
      faqs={[
        { id: "q1", title: "Is breakfast included?", content: "Yes, breakfast is complimentary with all room rates." },
        { id: "q2", title: "Do you offer parking?", content: "Valet parking is available for all guests 24/7." },
        { id: "q3", title: "Are pets allowed?", content: "Yes, we are a pet-friendly establishment." },
      ]}
  ...
  <div id="footer" data-section="footer">
      <FooterBase
      columns={[
        { title: "Links", items: [{ label: "Rooms", href: "#rooms" }, { label: "Amenities", href: "#amenities" }] },
        { title: "Policies", items: [{ label: "Privacy", href: "#" }, { label: "Terms", href: "#" }] },
      ]}
